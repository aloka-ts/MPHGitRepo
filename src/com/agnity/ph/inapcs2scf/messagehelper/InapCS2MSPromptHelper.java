 ...
 */
public class InapCS2MSPromptHelper {
	private static Logger logger = Logger.getLogger(InapCS2MSPromptHelper.class);
	...
	private static InformationToSend getInformationToSend(AnnSpec annSpec) throws ASNParsingException {
		...
		String sendOptionalParam = InapCS2ScfProtocolConfig.
				getConfigData(InapCS2ScfProtocolConfig.SEND_OPTIONAL_PARAMS_PA);
