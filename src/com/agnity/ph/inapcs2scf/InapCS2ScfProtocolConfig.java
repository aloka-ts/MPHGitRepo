 ...
 */
public class InapCS2ScfProtocolConfig implements Ss7ProtocolConfig {

    public static final String PROTOCOL_VARIANT = "INAPCS2SCF";
    ...
    private static final InapCS2ScfProtocolConfig inapCS2ScfProtocolConfig = new InapCS2ScfProtocolConfig();
    ...
    private static Logger logger = Logger.getLogger(InapCS2ScfProtocolConfig.class); 																						  // and ServiceInteractionIndicatorTwo in CONNECT Message
	...
	public static final String INAPCS2_SMPP_SIMULATOR = "INAPCS2_SMPP_SIMULATOR";
    ...
    static {
    	...
    	setConfigData(INAPCS2_SMPP_SIMULATOR, PhConstants.FALSE);
    ...
    public static InapCS2ScfProtocolConfig getInstance() {
        return inapCS2ScfProtocolConfig;
    }
...
//            }
            ...
            for (int i = 0; i < sLocalSsnList.length; i++) {
                ...
                if (localSpc == null) {
                    ...
                    logger.error("[PH]:: initializeSS7Param: INAP CS2 PC was null, using default value 6-64-2");
                }
...
//    }
    ...
    public Protocol getProtocol() {
        return Protocol.ITUINAPCS2_SCF;
    }
