...
/**
 * This class define the reason for releasing the call.
 * 
 * @author reeta
 *
 */
public interface AinScfRelReasonCode {

	int RSNRA_RECEIVED = 101;
	int TRANSIENT_CALL_FT = 102;
	int CALL_REDIRECTED = 103;
	int INAP_CALL_CONNECTED = 104;
	...
	int UNEXP_INFO_ANALYZE = 338;
	int UNEXP_INFO_COLLECTED = 339;
	int UNEXP_TERMINATION_ATTEMPT = 340;
	...
	int ARI_ASN_PARSING_FAIL = 667;
	int UNEXPECTED_RES_CLR = 668;
	int UNEXPECTED_CLOSE = 669;
	int UNEXPECTED_NTWK_BUSY = 670;
	int RC_ASN_PARSING_FAIL = 671;
	int RC_PARAM_OUT_OF_RANGE = 672;
	int NB_ASN_PARSING_FAIL = 673;
	int NB_PARAM_OUT_OF_RANGE = 674;
	int TERM_SEIZED_RECIEVED = 675;
	int INFO_COLLECT_ASN_PARSING_FAIL = 676;
	int INFO_COLLECT_INVALID_EXTN_TYPE = 677;
	int INFO_COLLECT_PARAM_OUT_OF_RANGE = 678;
	int INFO_ANALYZ_ASN_PARSING_FAIL = 679;
	int INFO_ANALYZ_INVALID_EXTN_TYPE = 680;
	int INFO_ANALYZ_PARAM_OUT_OF_RANGE = 681;
	Object AIN_CALL_CONNECTED = 682;
	int TERMINATION_ATTEMPT_ASN_PARSING_FAIL = 683;
	int TERMINATION_ATTEMPT_OUT_OF_RANGE = 684;

	// Play and Play and collect
	int AIN_DISCONNECT_AFTER_PLAY = 685;

	// Bns Parsing
	int BNS_ASN_PARSING_FAIL = 686;
	int BNS_INVALID_EXTN_TYPE = 687;
	int BNS_PARAM_OUT_OF_RANGE = 688;
	int INVALID_BNS_QUERY = 689;
	// GN Parsing
	int GN_ASN_PARSING_FAIL = 690;
	int GN_INVALID_EXTN_TYPE = 691;
	int GN_PARAM_OUT_OF_RANGE = 692;
	int INVALID_GN_QUERY = 693;
    //OLNS Parsing
	int OLNS_ASN_PARSING_FAIL = 694;
	int OLNS_INVALID_EXTN_TYPE = 695;
	int OLNS_PARAM_OUT_OF_RANGE = 696;
	int INVALID_OLNS_QUERY = 697;
 	
	// Outbound Gateway
	int OBGW_NOT_AVAILABLE = 698;
     //NP Query Parsing
	int PROVIDE_INSTRUCTION_ASN_PARSING_FAIL = 698;
	int PROVIDE_INSTRUCTION_INVALID_EXTN_TYPE = 699;
	int PROVIDE_INSTRUCTION_PARAM_OUT_OF_RANGE = 700;
	int INVALID_PROVIDE_INSTRUCTION = 701;
	int UNEXP_PROVIDE_INSTRUCTION = 338;
	int REJECT_NO_NEXT_SERVICE = 668;
