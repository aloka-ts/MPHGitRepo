...
/**
 * This class is used to define Release reason codes for a call
 */
public interface InapCS1ScfRelReasonCode {
	...
	// Cause value for CDR
	String ERB_ANS_CV ="7";
	String ERB_CALLED_PARTY_BUSY_CV ="5";
	String ERB_NO_ANS_CV= "6";
	String ERB_ROUTE_SELECT_FAILURE_CV = "4";
	String ERB_ABANDON_CV = "10";
	String ERB_DISCONNECT_CV = "9";
	String ERB_DEFAULT_CV = "31";
