...
import com.agnity.inapitutcs2.asngenerated.ApplyChargingReportArg;
import com.agnity.inapitutcs2.asngenerated.AssistRequestInstructionsArg;
import com.agnity.inapitutcs2.asngenerated.BCSMEvent;
import com.agnity.inapitutcs2.asngenerated.BearerCapability;
import com.agnity.inapitutcs2.asngenerated.CallSegmentID;
import com.agnity.inapitutcs2.asngenerated.CalledPartyNumber;
import com.agnity.inapitutcs2.asngenerated.CallingPartyNumber;
import com.agnity.inapitutcs2.asngenerated.ChargeNumber;
import com.agnity.inapitutcs2.asngenerated.ConnectArg;
import com.agnity.inapitutcs2.asngenerated.ContinueWithArgumentArg;
import com.agnity.inapitutcs2.asngenerated.CorrelationID;
import com.agnity.inapitutcs2.asngenerated.CriticalityType;
import com.agnity.inapitutcs2.asngenerated.DestinationRoutingAddress;
import com.agnity.inapitutcs2.asngenerated.Digits;
import com.agnity.inapitutcs2.asngenerated.EntityReleasedArg;
import com.agnity.inapitutcs2.asngenerated.EventNotificationChargingArg;
import com.agnity.inapitutcs2.asngenerated.EventReportBCSMArg;
import com.agnity.inapitutcs2.asngenerated.EventSpecificInformationBCSM;
import com.agnity.inapitutcs2.asngenerated.EventTypeBCSM;
import com.agnity.inapitutcs2.asngenerated.ExtensionField;
...
import com.agnity.inapitutcs2.asngenerated.IPAvailable;
import com.agnity.inapitutcs2.asngenerated.InitialDPArg;
import com.agnity.inapitutcs2.asngenerated.Integer4;
import com.agnity.inapitutcs2.asngenerated.LegID;
import com.agnity.inapitutcs2.asngenerated.LegType;
import com.agnity.inapitutcs2.asngenerated.LocationNumber;
import com.agnity.inapitutcs2.asngenerated.MonitorMode;
import com.agnity.inapitutcs2.asngenerated.OriginalCalledPartyID;
import com.agnity.inapitutcs2.asngenerated.ReleaseCallArg;
import com.agnity.inapitutcs2.asngenerated.RequestReportBCSMEventArg;
import com.agnity.inapitutcs2.asngenerated.ResetTimerArg;
import com.agnity.inapitutcs2.asngenerated.ServiceInteractionIndicatorsTwo;
import com.agnity.inapitutcs2.asngenerated.SpecializedResourceReportArg;
import com.agnity.inapitutcs2.asngenerated.TimerID;
import com.agnity.inapitutcs2.asngenerated.TimerID.EnumType;
import com.agnity.inapitutcs2.asngenerated.TimerValue;
...
import com.agnity.inapitutcs2.datatypes.OrigCalledPartyId;
import com.agnity.inapitutcs2.datatypes.RedirectReason;
...
import com.agnity.inapitutcs2.enumdata.GTIndicatorEnum;
...
import com.agnity.inapitutcs2.enumdata.RoutingIndicatorEnum;
import com.agnity.inapitutcs2.enumdata.SPCIndicatorEnum;
import com.agnity.inapitutcs2.enumdata.SSNIndicatorEnum;
 ...
 */
public class InapCS1ScfProtocolParser {

	private static Logger logger = Logger.getLogger(InapCS1ScfProtocolParser.class);
	...
	public static void parseIdp(InvokeIndEvent invokeIndEvent, CallData callData) throws ASNParsingException, CriticalityTypeException, ParameterOutOfRangeException, Exception {
		...
		try {
			...
			if (idpArg.isBearerCapabilityPresent()) {
				BearerCapability bearerCapability = idpArg.getBearerCapability();

				if(bearerCapability.isBearerCapSelected()){
					com.agnity.inapitutcs2.datatypes.BearerCapability bcap =
							com.agnity.inapitutcs2.datatypes.BearerCapability.decodeBearerCapability(bearerCapability.getBearerCap());
	 ...
	 * @return an instance of PhoneNumber
	 */
	public static PhoneNumber parseCalledPartyNum(int dialogueId, CalledPartyNum calledPartyNum) {
		if (logger.isDebugEnabled()) {
	...
	public static byte[] createConnectForTerm(CallData callData, Action action) throws Exception {
		...
		if (logger.isDebugEnabled()) {
			logger.debug("[PH]:: Inside createConnectForTerm");
			logger.debug("[PH]:: needToSendCallingNumber in connect : " + action.isSendCallingParty());
		}

		String isSendOptionalParam = SipProtocolConfig.getConfigData(InapCS1ScfProtocolConfig.SEND_OPTIONAL_PARAMS_CONNECT);
		if(logger.isDebugEnabled()){
		...
		if(null != leg2Data.get(LegDataAttributes.P_CALLING_PARTY)) {
		...
		String sendExtnField=InapCS1ScfProtocolConfig.getConfigData(InapCS1ScfProtocolConfig.EXTENSION4_ENABLED);
	...
	public static void parseErbcsm(InvokeIndEvent invokeIndEvent, CallData callData) throws Exception {
		...
		if (eventReportBCSMArg.isEventSpecificInformationBCSMPresent() || eventReportBCSMArg.getEventTypeBCSM() != null) {
			...
			case oAbandon: {
				...
				callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_OABANDON_RCVD);
				parseReleaseCause(releaseCause, callData);

				// if last state was USER_INTERACTION then send MS_PLAY_FAILURE
				if(inapCallState == InapCallStates.MS_PLAY){
					InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.MS_PLAY);
					event = new Event(EventType.EVENT_PLAY_FAILURE, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
				}else if(inapCallState == InapCallStates.MS_PLAYCOLLECT){
					InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.MS_PLAYCOLLECT);
					event = new Event(EventType.EVENT_PNC_FAILURE, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
				}else{
					leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_ABANDON_CV);
					...
					leg2Data.set(LegDataAttributes.P_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_OABANDON_RCVD);
				}
			}
			break;
			case oDisconnect: {
				...
				if (eventReportBCSMArg.isLegIDPresent()) {
					...
					if (legType.isSendingSideIDSelected()) {
						legId = CallDataAttribute.P_LEG2.name();
						leg2Data.set(LegDataAttributes.DISCONNECT_LEGID, "2");
					}else{
						leg2Data.set(LegDataAttributes.DISCONNECT_LEGID, "1");
					}
				}

				callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_ODISC_RCVD);
				...
				if(inapCallState == InapCallStates.MS_PLAY){
					...
					leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_DISCONNECT_CV);
					event = new Event(EventType.EVENT_DISCONNECT, Protocol.ITUINAPCS1_SCF, legId);
					InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.TERMINATED);
				}
			}
			break;
			...
			case oCalledPartyBusy: {
				...
				leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_CALLED_PARTY_BUSY_CV);
				event = new Event(EventType.EVENT_FAILURE, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
			...
			case oAnswer: {
				...
				InapCS1ScfProtocolUtil.startMaxCallDurationTimer(dialogueId, callData, tcapSession);
				InapCS1ScfProtocolUtil.startActivityTestTimer(dialogueId, callData, tcapSession);
				leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_ANS_CV);
				event = new Event(EventType.EVENT_SUCCESS, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
			...
			case oNoAnswer: {
				...
				leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_NO_ANS_CV);
				event = new Event(EventType.EVENT_FAILURE, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
			...
			case routeSelectFailure: {
				...
				leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_ROUTE_SELECT_FAILURE_CV);
				event = new Event(EventType.EVENT_FAILURE, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
			...
			case oMidCall: {
				...
				leg2Data.set(LegDataAttributes.P_ERB_CAUSE_CODE, InapCS1ScfRelReasonCode.ERB_DEFAULT_CV);
				event = new Event(EventType.EVENT_DTMF, Protocol.ITUINAPCS1_SCF, CallDataAttribute.P_LEG2.name());
			...
			if(lastRxDialoguePrimitiveType == TcapConstants.PRIMITIVE_END){
				...
				InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.TERMINATED);
				InapCS1ScfProtocolHelper.notifyCallDropped(tcapSession, true);
			} else {
	...
	private static void parseMidCall(CallData callData,
		...
		if (logger.isDebugEnabled()) {
			logger.debug("[PH]:: Inside process parseMidCall");
		}
		...
		if (erbcsmArg.isLegIDPresent()) {
			...
			if (legId.isReceivingSideIDSelected()) {
				...
				if ((legType.getValue()[0]) != (leg2Type.getValue()[0])) {
					...
					callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_INVALID_LEG_TYPE);
					return InapCS1ScfProtocolHelper.getASNParsingFailureAction(tcapSession, MESSAGE.ERB_BUSY, FAILTYPE.DEFAULT);

				}// end if legType value check

				//changes for alternate routing feature start
				termLegData.set(LegDataAttributes.P_CAUSE_CODE, InapCS1ScfRelReasonCode.CAUSE_CODE_BUSY);
				...
				callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_INVALID_RECEIVING_SIDE);
				return InapCS1ScfProtocolHelper.getASNParsingFailureAction(tcapSession, MESSAGE.ERB_BUSY, FAILTYPE.DEFAULT);
			}
		}// @end if erbcsmArg.isLegIDPresent() no else as standard says assume default as 2

		InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.SERVICE_LOGIC);
		callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.BUSY_RCVD_FROM_TERM);
	...
	static Action[] parseAns(CallData callData, EventReportBCSMArg erbcsmArg, TcapSession tcapSession) throws ASNParsingException {
		...
		if (erbcsmArg.isLegIDPresent()) {
			...
			if (legId.isReceivingSideIDSelected()) {
				...
				if ((legType.getValue()[0]) != (leg2Type.getValue()[0])) {
					...
					callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_INVALID_LEG_TYPE);
					return InapCS1ScfProtocolHelper.getASNParsingFailureAction(tcapSession, MESSAGE.ERB_ANS, FAILTYPE.DEFAULT);
		...
		InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.TERM_CONNECTED);
		callData.set(CallDataAttribute.P_CALL_CONNECT_TIME, new Date());

		// calculate alerting time
		...
		InapCS1ScfProtocolUtil.startCdrTimer(tcapSession);
		if (logger.isDebugEnabled()) {
	...
	static Action[] parseNoAns(CallData callData, EventReportBCSMArg erbcsmArg, TcapSession tcapSession) throws ASNParsingException {
		...
		if (erbcsmArg.isLegIDPresent()) {
			...
			if (legId.isReceivingSideIDSelected()) {
				...
				if ((legType.getValue()[0]) != (leg2Type.getValue()[0])) {
					...
					callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_INVALID_LEG_TYPE);
					return InapCS1ScfProtocolHelper.getASNParsingFailureAction(tcapSession, MESSAGE.ERB_NOANS, FAILTYPE.DEFAULT);

				}// end if legType value check

				//changes for alternate routing feature start
				termLegData.set(LegDataAttributes.P_CAUSE_CODE, InapCS1ScfRelReasonCode.CAUSE_CODE_NOANSWER);
		...
		InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.SERVICE_LOGIC);
		callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.NOANS_RCVD_FROM_TERM);
		return null;
	...
	private static Action[] parseRouteSelectFailure(CallData callData, EventReportBCSMArg erbcsmArg, TcapSession tcapSession) throws ASNParsingException {
		...
		if (erbcsmArg.isLegIDPresent()) {
			...
			if (legId.isReceivingSideIDSelected()) {
				...
				if ((legType.getValue()[0]) != (leg2Type.getValue()[0])) {
					...
					callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ERB_INVALID_LEG_TYPE);
					return InapCS1ScfProtocolHelper.getASNParsingFailureAction(tcapSession, MESSAGE.ERB_ROUTESELECTFAILURE, FAILTYPE.DEFAULT);

				}// end if legType value check

				termLegData.set(LegDataAttributes.P_CAUSE_CODE, InapCS1ScfRelReasonCode.ROUTESELECTFAILURE_RCVD_FROM_TERM);
				if (logger.isDebugEnabled()) {
					logger.debug("[PH]:: Setiing P_CAUSE_CODE :" + termLegData.get(LegDataAttributes.P_CAUSE_CODE));
		...
		InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.SERVICE_LOGIC);
		callData.set(CallDataAttribute.NP_RELEASE_REASON_CODE, InapCS1ScfRelReasonCode.ROUTESELECTFAILURE_RCVD_FROM_TERM);
		return null;
	...
	public static byte[] createReleaseCall(CallData callData, Action action) throws Exception {
		...
		} else if (legData.get(LegDataAttributes.NP_RELEASE_REASON_VALUE) != null){
			try{
	...
	public static byte[] createFci(CallData callData) throws Exception {
		...
		if(null != fciMsg) {
			...
			if(logger.isDebugEnabled()){
				logger.debug("FCI Billing Charging Characteristics byte:" + CommonUtils.formatBytes(fciChrInfo));
			}
	...
	public static void parseAcr(InvokeIndEvent invokeIndEvent, CallData callData) throws InvalidInputException, EnumParamOutOfRangeException, ASNParsingException, ParameterOutOfRangeException {
		...
		if (legState.equals(InapCallStates.TERM_CONNECTED)) {
			InapCS1ScfProtocolUtil.updateSS7CallState(legData, InapCallStates.TERM_CONNECTED_ACR);
		}
	}
	...
	public static byte[] createEntityRelease(CallData callData, Action action) throws Exception {
		...
		CallSegmentID segRId = null;
		csFailureSeq.setCallSegmentID(segRId);
	...
	public static byte[] createResetTimer(CallData callData) throws Exception {
		...
		timerValue.setValue(new Integer4(100));
		...
		opCodes.add(InapOpCodes.RESET_TIMER);

		LinkedList<byte[]> resetLinkList = InapOperationsCoding.encodeOperations(opObjects, opCodes);
